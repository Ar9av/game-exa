...
export const GDD = {
  ...
  entities: [
    { id: 'SHIP',     kind: 'player',     color: 'cyan',   desc: 'A small cyan triangular ship', states: ['idle', 'walk'], speed: 140, hp: 3 },
    { id: 'ASTEROID', kind: 'enemy',      color: 'gray',   desc: 'Chunky gray rock fragment',     states: ['idle'],         speed: 60,  hp: 1 },
